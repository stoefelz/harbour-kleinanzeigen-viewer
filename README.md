...
Download the rpm and install the app - when you have not enabled my openrepos repository you must install the seperate python packages from <a href="https://github.com/stoefelz/python3-packages-sailfishos">here</a>.
